                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">Total: <span
                                                            class="counter-value" data-target="{{count(\App\Models\Package::all())}}">0</span>
                                                    </h4>
                                                    <a href="{{route('package.index')}}" class="text-decoration-underline">Manage all
                                                        responses</a>
                                                </div>
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">Total: <span
                                                            class="counter-value" data-target="{{count(\App\Models\ApplyJob::all())}}">0</span></h4>
                                                    <a href="{{route('career-response.index')}}" class="text-decoration-underline">View all responses</a>
                                                </div>
                                                <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">Total: <span
                                                            class="counter-value" data-target="{{count(\App\Models\RequestQuote::all())}}">0</span>
                                                    </h4>
                                                    <a href="{{route('quote-response.index')}}" class="text-decoration-underline">See details</a>
                                                </div>
                                                <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">Total: <span
                                                            class="counter-value" data-target="{{count(\App\Models\Contact::all())}}">0</span>
                                                    </h4>
                                                    <a href="{{route('contact.index')}}" class="text-decoration-underline">View all list</a>
                                                </div>
                                                <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="col-xxl-4 col-lg-6">
                                    <div class="card card-height-100">
                                        <div class="card-header align-items-center d-flex">
                                            ...
                                            <a href="{{route('our-work.index')}}" type="button" class="btn btn-soft-primary btn-sm">
                                                View all
                                            </a>
                                        </div><!-- end card-header -->
