                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">$<span
                                                            class="counter-value" data-target="{{count(\App\Models\OurWork::all())}}">0</span>k
                                                    </h4>
                                                    <a href="#" class="text-decoration-underline">View all published
                                                        work</a>
                                                </div>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div
                                                                    ...
                                                                    <img src="{{asset('assets/backend/images/products/img-1.png')}}"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div
                                                                    class="avatar-sm bg-light rounded p-1 me-2">
                                                                    <img src="{{asset('assets/backend/images/products/img-4.png')}}"
                                                                         alt="" class="img-fluid d-block" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-14 my-1"><a
                                                ...
                                                <table
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{asset('assets/backend/images/companies/img-2.png')}}"
                                                                         alt="" class="avatar-sm p-2" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <h5 class="fs-14 my-1 fw-medium"><a
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{asset('assets/backend/images/companies/img-3.png')}}"
                                                                         alt="" class="avatar-sm p-2" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0 me-2">
                                                                    <img src="{{asset('assets/backend/images/companies/img-5.png')}}"
                                                                         alt="" class="avatar-sm p-2" />
                                                                </div>
                                                                <div class="flex-grow-1">
                                                                    <h5 class="fs-14 my-1 fw-medium"><a
