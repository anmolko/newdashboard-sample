            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="service-sub-description-input" value="{{@$edit->sub_description}}" name="sub_description"
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                <img id="current-feature-img" src="{{ ($edit->feature_image !== null) ? asset('images/service/'.$edit->feature_image) :  asset('images/default-image.jpg') }}" class="position-relative img-fluid img-thumbnail blog-feature-image">
                                <input  type="file" accept="image/png, image/jpeg" hidden
                                        id="profile-feature-img-file-input" onchange="loadbasicFile('profile-feature-img-file-input','current-feature-img',event)" name="feature_image"
