...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            {!! Form::open(['route' => ['user.update', $user->id],'method'=>'PUT','class'=>'needs-validation','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    @if(@$user->user_type == "admin")
                                                        <select class="form-select mb-3" aria-label="Default select" name="user_type">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select mb-3" aria-label="Default select" name="gender">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="hstack gap-2 justify-content-end">
                                                    <button type="submit" class="btn btn-soft-success">Updates</button>
                                                </div>
                                            </div>
                                            <!--end col-->
                                        </div>
