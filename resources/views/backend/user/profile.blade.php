                            ...
                            <div class="tab-pane active" id="overview-tab" role="tabpanel">
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex mb-4">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{asset('assets/backend/images/small/img-4.jpg')}}" alt=""
                                                ...
                                                <div class="d-flex mb-4">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{asset('assets/backend/images/small/img-5.jpg')}}" alt=""
                                                             height="50" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3 overflow-hidden">
                                                        <a href="javascript:void(0);">
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{asset('assets/backend/images/small/img-6.jpg')}}" alt=""
                                                             height="50" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3 overflow-hidden">
                                                        <a href="javascript:void(0);">
                                    ...
                                    <div class="col-xxl-9">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title">Projects ed</h5>
                                                <!-- Swiper -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xxl-4">
                                                            <div class="row border border-dashed gx-2 p-2 mb-2">
                                                                <div class="col-4">
                                                                    <img src="{{asset('assets/backend/images/small/img-2.jpg')}}"
