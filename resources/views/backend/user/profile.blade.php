                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="acitivity-timeline">
                                            ...
                                            <div class="acitivity-item {{($loop->first) ? "":"py-3"}} d-flex">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                        ...
                                                        @if($activity->event == 'created')
                                                            <h6 class="mb-1">{{$activity->log_name}}
                                                                <span class="badge bg-soft-success text-success align-middle">{{$activity->event}}</span>    </h6>
                                                        @endif
                                                        @if($activity->event == 'updated')
                                                            <h6 class="mb-1">{{$activity->log_name}}
                                                                <span class="badge bg-soft-secondary text-secondary align-middle">{{$activity->event}}</span></h6>
                                                        @endif
                                                        @if($activity->event == 'deleted')
                                                            <h6 class="mb-1">{{$activity->log_name}}
                                                                <span class="badge bg-soft-danger text-danger align-middle ms-1">{{$activity->event}}</span></h6>
                                                        @endif
                                                                ...
                                                                @if($activity->event == 'created')
                                                                   ...
                                                                   <p class="text-capitalize">
                                                                    @foreach($activity->properties['attributes'] as $a=>$value)
                                                                        @if($a == 'image' || $a == 'feature_image' || $a == 'banner_image')
                                                                            <div class="row">
                                                                                <div class="col-xxl-4">
                                                                                    <div class="row border border-dashed p-2 mb-2">
                                                                                        <div class="col-4">
                                                                                            <img src="{{asset('assets/backend/images/small/img-2.jpg')}}" alt="" class="img-fluid rounded">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        @else
                                                                             <span class="text-success"> {{$a}}</span>  :   {{$value}},
                                                                        @endif
                                                                    @endforeach
                                                                   </p>
